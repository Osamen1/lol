...
if __name__ == "__main__":
    ...
    databases = {
        ...
        "conn_ai_history": "db/ai_histories.sqlite",
    }
    ...
    def create_tables():
        ...
        with connections["conn_ai_history"] as conn_ai_history:
            conn_ai_history.execute("""CREATE TABLE IF NOT EXISTS ai_chat_history (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
                user_id INTEGER,
                channel_name TEXT,
                role TEXT,
    ...
    create_tables()
        ...
        """)
    async def load_cogs():
        cogs = ["wordgame", "aichat", "olddb", "control", "alliance", "alliance_member_operations", "bot_operations", "logsystem", "support_operations", "changes", "w", "wel", "other_features", "bear_trap", "id_channel", "bear_trap_editor"]
